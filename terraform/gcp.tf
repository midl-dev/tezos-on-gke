...
resource "google_project" "tezos_baker" {
...
data "google_project" "tezos_baker" {
...
resource "google_container_node_pool" "tezos_baker_node_pool" {
  provider = google-beta
  project = local.tezos_baker_project_id
  name       = "tzbaker-pool"
  location   = var.region
